...
rePosition= eval(model_sp['reposition'])
max_relative = eval(model_sp['max_relative'])
...
model = UnlabeledEntityNet(model_path,categories_size,hidden_size=hidden_size,abPosition=abPosition,rePosition=rePosition,re_maxlen= re_maxlen,max_relative=max_relative)
